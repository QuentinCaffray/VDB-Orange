# Planning de développement — VDB-Orange
...
- Migrations
- Seed réaliste : 10 vendeurs avec leurs couleurs, indicateurs, tâches d'exemple
...
- `GET | POST /sales/daily` — saisie du stepper « Je pointe »
- `GET | PUT /objectives/monthly` — cibles par vendeur (admin)
- `GET | PUT /indicators` — liste d'indicateurs éditable (admin)
...
- Segment « Équipe » : jauges empilées horizontales (`flex: count`) par vendeur + contour vendeur connecté
- Légende couleurs vendeurs en bas

### J9 — Jeu 03/07 · Objectifs — onglet Mois
- Vue vendeur : anneau SVG de progression (vert `#22A650`), barres par indicateur (en cours vs validé), mention cadenas direction
- Vue admin : sélecteur de vendeur, objectifs éditables par champ
...
- Gestion des comptes admin : liste des 10 vendeurs, attribution couleurs, CUID
- Historique calendaire : grille mensuelle lecture seule, jours avec activité, anti-triche
- PWA : manifest, service worker Workbox, icônes (192×512)
...
| 6 | Objectifs · Jour · Je pointe | Vendeur | J8 |
| 7 | Objectifs · Jour · Équipe | Vendeur | J8 |
