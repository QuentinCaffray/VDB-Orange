...
const tabs = [
  {
    ...
    label: 'Tâches',
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={active ? '#FF7900' : '#B7AEA4'} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {({ isActive }) => (
              <>
                ...
                <span
                  ...
                  style={{ color: isActive ? '#FF7900' : '#B7AEA4' }}
                >
                  {tab.label}
                </span>
              </>
