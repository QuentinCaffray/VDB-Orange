      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pr-12 rounded-[14px] text-sm font-semibold outline-none transition-colors"
            style={{
...
function EyeIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9A9088" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
